...
aut aut aut maxime quia temporibus ut omnis`}],Pc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Lc=({user:{email:e,name:t}})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e}`,children:t}),Tc=({comment:{name:e,email:t,body:i}})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:e})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${t}`,children:t})]}),O.jsx("div",{className:"CommentInfo__body",children:i})]}),Mc=({comments:e})=>O.jsx("div",{className:"CommentList",children:e.map(t=>O.jsx(Tc,{comment:t},t.id))}),Rc=({post:{title:e,body:t,user:i,comments:n}})=>{const a=n.length?O.jsx(Mc,{comments:n}):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"});return O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:e}),O.jsxs("p",{children:[" Posted by ",i&&O.jsx(Lc,{user:i})]})]}),O.jsx("p",{className:"PostInfo__body",children:t}),O.jsx("hr",{}),a]})},Dc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsx(Rc,{post:t},t.id))});function Ur(e,t){return e.find(i=>i.id===t)||null}function jc(){const e=zc.map(t=>({...t,user:Ur(Pc,t.userId),comments:[]}));return Nc.forEach(t=>{const i=Ur(e,t.postId),n={...t,post:i};i==null||i.comments.push(n)}),e}const Oc=jc(),Fc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Dc,{posts:Oc})]});tm(document.getElementById("root")).render(O.jsx(Fc,{}));
